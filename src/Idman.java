public class Idman {
    ...
    public int setsquat_sayisi() {
        return squat_sayisi;
    }

    public void getSquat_sayisi(int squat_sayisi) {
        this.squat_sayisi= squat_sayisi;
    }


    public void harektYap(String hareketTuru , int sayi) {
    ...
    public void burpeeYap(int sayi) {
        ...
        if(burpee_sayisi == 0) {
            ...
            System.out.println("Hedefleniğiniz burpee sayısını geçtiniz.");
            burpee_sayisi= 0;
